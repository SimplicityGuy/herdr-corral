...
falling through to `HerdrPreview`, the default, for the rest; a bead adding its own editor for a
remaining section replaces just its own line. The editors a preview
